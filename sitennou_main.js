...
・繰り返し遊びたいのだが、
しかしイベントリスナ（タッチ）を繰り返すと繰り返すたびに重複してタッチが起こってしまうので、イベントリスナをその都度削除しようと思ったが調べても書き方がよくないらしくできなかったので、タッチはfunctionの外に出して繰り返さないようにして、当たりの場合は判定用の四角を被せてそれをその都度消すやり方でやった。削除の書き方は？
